        ...
        <div class="row">
            ...
            <div class="row">
                ...
                <div class="card  col-sm-6 col-md-6 text-center border-0 shadow-none bg-transparent">
                    ...
                    <label>コメント</label>
                    <textarea class="w-auto py-2 border border-gray-300 rounded-md font-semibold whitespace-pre-line" cols="60" rows="5" readonly style="resize: none; border-radius: 10px;">{{ $recipe->comment }}</textarea>
                </div>
